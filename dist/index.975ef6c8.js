...
${frame.code}`;
          ...
          try {
            ...
            breedSelect.innerHTML =
              breeds
                ...
                .join('') || '<option disabled>No breeds available</option>';
          } catch {
            toggleError(true);
          } finally {
            toggleLoader(false);
    ...
    `;
      ...
      { './cat-api.js': 'd7YdZ', './style.css': 'bhJkM' },
    ],
    d7YdZ: [
      function (require, module, exports) {
        ...
        (0, _axiosDefault.default).defaults.headers.common['x-api-key'] =
    ...
    '5By4s': [
      function (require, module, exports) {
        ...
        /* Creating a function that will check if an object has a property. */ const hasOwnProperty =
          (
            ({ hasOwnProperty: hasOwnProperty1 }) =>
            (obj, prop) =>
              hasOwnProperty1.call(obj, prop)
          )(Object.prototype);
        /**
        ...
        class AxiosHeaders {
          ...
          set(header, valueOrRewrite, rewrite) {
            ...
            if (
              ...
              for (const [key1, value] of header.entries())
                setHeader(value, key1, rewrite);
